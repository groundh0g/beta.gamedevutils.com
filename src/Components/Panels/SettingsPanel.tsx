        ...
        <div className={`panel panel-settings ${classPanel}`}>
            ...
            <div className="panel-content">
                ...
                <PanelHeader title="Spritesheet Size Options" label="Dimensions" groupName="dimensions" isShown={panelShowStates[makePanelId("dimensions")]} showHideContent={showHideContent}>
                    <div className="panel-label"><InputText label="Width" title="Spritesheet Width" field="width" includeLookup={true}/></div>
                    <div className="panel-label"><InputText label="Height" title="Spritesheet Height" field="height" includeLookup={true}/></div>
